    ...
    return (
        <>
            <div className='bg-gray-900 pb-8'>
                <div className='w-auto lg:h-screen  lg:w-[90%]  text-white '>
                    <div className=' grid grid-cols-1  h-fit  lg:grid lg:grid-cols-2 lg:h-[450px] '>
                        <div className=' grid justify-items-center items-center ml-10 '>
                            <section className='p-12  pb-0 lg:p-12 lg:pt-0 grid  items-center   '>
                        ...
                        <div className='mt-4 grid justify-items-center items-start'>
                            <img src={charity} className="lg:ml-[40%] h-[350px] w-[350px] lg:h-[80%] lg:w-[70%] " />
                        </div>
                        <div className='lg:w-[1280px] grid justify-items-center'>
                            <button className='lg:-mt-16 lg:ml-[%] p-2 h-12 w-44  text-center border-emerald-500 lg:h-16 lg:w-64 bg-red-500 lg:p-3 rounded-full shadow-gray-500 lg:shadow-md text-white lg:text-3xl lg:font-semibold bg-gradient-to-r from-green-500 to-green-300  hover:from-white hover:to-neutral-100
                ...
                <div className=' grid grid-cols-1 mt-4   '>
                    ...
                    <section className='bg-gradient-to-r from-green-500 to-green-300 via-green-200 h-[350px] w-[450px] ml-7 rounded lg:h-64 lg:w-[95%] lg:ml-8 '>
                ...
                <section className='h-fit w-[450px] text-green-500 ml-4 rounded lg:mt-0 lg:w-[90%] '>
                    <div className=''>
                        ...
                        <div className='lg:grid lg:grid-cols-3 text-gray-800 lg:justify-items-start lg:gap-x-14 lg:mt-4 mb-4 '>
                            {
                                fund.map((funde) => {
                                    ...
                                    return (
                                        <>
                                            <section key={id} className="mt-9 p-2 lg:mb-0 rounded-t-2xl  mb-2 border  cursor-pointer lg:h-[470px] lg:w-[95%] lg:ml-24 bg-gradient-to-r from-green-500 to-green-300 via-green-200 hover:from-green-500 hover:to-green-700  rounded-2xl">
                                                <img src={poster} className=' lg:w-[100%] lg:rounded-t-xl' />
